    ...
    <div>
        <div class="grid">
            <div class="col-12">
                <Message>
                    <p class="p-0 m-0">
                        <strong>หมายเหตุ : </strong> กรณีบัตรเติมเงินหรือเติมเกมส์ รหัสหรือโค้ดจะถูกส่งทางข้อความ SMS เบอร์โทรกรอกในตามระบบ
                    </p>
                </Message>
            </div>
            <div class="col-12">
...
export default {
    ...
    async mounted() {
        ...
        await axios.get(`${process.env.VUE_APP_SHOP}counter_service/service/card`, {
            headers: {
        ...
        confirm() {
            ...
            this.$confirm.require({
                ...
                accept: async () => {
                    ...
                    this.$store.commit('setLoading', true);
                    await axios.post(`${process.env.VUE_APP_SHOP}counter_service/card_topup/verify`, {
