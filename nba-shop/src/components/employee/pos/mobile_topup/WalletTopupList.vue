    ...
    <div>
        <div class="grid">
            <div class="col-12">
                <Message>
                    <p class="p-0 m-0">
                        <strong>หมายเหตุ : </strong> สถานะรายการจะส่งไปยัง SMS ตามเบอร์โทรที่ทำรายการ
                    </p>
                </Message>
            </div>
            <div class="col-12">
...
export default {
    ...
    async mounted() {
        ...
        await axios.get(`${process.env.VUE_APP_SHOP}counter_service/service/wallet`, {
            headers: {
    ...
    methods: {
        ...
        confirm() {
            ...
            this.$confirm.require({
                message: `ยืนยันการเติมเงินวอลเล็ต ${this.service.productname} ที่เบอร์ ${this.mobile} จำนวน ${this.numberFormat(this.price)} บาท`,
                header: 'เติมเงินวอลเล็ต',
                ...
                accept: async () => {
                    ...
                    this.$store.commit('setLoading', true);
                    await axios.post(`${process.env.VUE_APP_SHOP}counter_service/wallet/verify`, {
