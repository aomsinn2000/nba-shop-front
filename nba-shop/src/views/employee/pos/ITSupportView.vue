<template>
  <div>
    <div class="grid">
      <div class="col-12">
        <h1 class="text-center">บริการ IT-Support</h1>
      </div>
    </div>
    <div class="grid">
      <div class="col-12 lg:col-5">
        <div class="grid">
          ...
          <div class="col-12">
            <Panel header="STEP 2. บริการ IT-Support">
              <MediaList />
            </Panel>
          </div>
        </div>
...
import MediaList from '@/components/employee/pos/itsupport_service/MediaList.vue';
import CheckOut from '@/components/employee/pos/itsupport_service/CheckOut.vue';
import OrderList from '@/components/employee/pos/itsupport_service/OrderList.vue'
import CustomerDisplay from '@/components/employee/pos/CustomerDisplay.vue';
import CheckOutButton from '@/components/employee/pos/itsupport_service/CheckOutButton.vue';
export default {
  components: {
