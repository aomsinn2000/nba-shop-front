<template>
  <div>
    <div class="grid">
      <div class="col-12">
        <h1 class="text-center">บริการ ภาษี (รถยนต์ - รถจักรยานยนต์)</h1>
      </div>
    </div>
    <div class="grid">
        ...
        <div class="grid">
          <div class="col-12">
            <Panel header="STEP 1. รายละเอียดลูกค้า">
              ...
              <div class="grid">
                ...
                <div class="col-12">
                  <div class="grid">
                    ...
                    <div class="col-12 lg:col-1 ml-3">
                      <div class="field">
              ...
              <div class="grid">
                <div class="col-12">
                  <marquee-text class="text-slide" :repeat="5">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;กรณียังไม่ได้ต่อ พ.ร.บ. ให้ทำรายการต่อ พ.ร.บ. ก่อนดำเนินการต่อภาษี&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</marquee-text>
                </div>
              </div>
            </Panel>
          </div>
          <div class="col-12">
            <Panel header="STEP 2. บริการ พ.ร.บ. ภาษีและประกัน">
              <Taxlist v-if="!checkOrder()" />
...
import Taxlist from '@/components/employee/pos/tax_service/TaxList.vue';
import CheckOut from '@/components/employee/pos/tax_service/CheckOut.vue';
import OrderList from '@/components/employee/pos/tax_service/OrderList.vue'
import CustomerDisplay from '@/components/employee/pos/CustomerDisplay.vue';
import CheckOutButton from '@/components/employee/pos/tax_service/CheckOutButton.vue';
export default {
  components: {
    Taxlist, 
    CheckOut, 
  ...
  async created() {
    ...
    document.title = 'บริการต่อภาษี (รถยนต์ - รถจักรยานยนต์)'
  },
  ...
  methods: {
      ...
      await axios.get(`${process.env.VUE_APP_SHOP}more/platform/member/${this.tel_platform}`, {
        ...
        if (this.cus_address !== '') {
          if (this.province === null || this.state === null || this.district === null || this.zip_code === '') {
            this.$toast.add({ severity: 'warn', summary: 'แจ้งเตือน', detail: 'กรุณากรอกที่อยู่ เพื่อใช้ในการออกใบกำกับภาษี', life: 5000 });
            return false;
          } else {
    ...
    checkOrder() {
      if (this.$store.getters.order_tax_detail.length !== 0) {
        return true;
      } else {
        return false;
      }
